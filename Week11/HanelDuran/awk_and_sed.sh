...
awk '/\xf0\x9f\x98\x82/ {print "found ROFL!"}' sample_text.txt


echo "=====SED====="

sed -n 's/\o320\o244\o321\o221\o320\o276\o321\o200/Fyodor/p' sample_text.txt
...
sed -n 's/^.*\xf0\x9f\x98\x82\.*$/found ROFL/p' < sample_text.txt
